...
export const SLIDES = [
  {
    ...
    highlight: "Passport",
    description:
      "Track every dish you taste, rate your favorites, and map your foodie journey.",
  },
  {
    title: "Discover New",
    highlight: "Flavors",
    description:
      "Explore curated collections of the best hidden gems in your city.",
  },
  {
    title: "Share the",
    highlight: "Joy",
