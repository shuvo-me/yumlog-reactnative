  ...
  return (
    <YStack f={1} backgroundColor="$backgroundDark">
      ...
      <XStack 
        ...
        borderColor="rgba(255,255,255,0.05)"
      >
        <Text fontSize="$6" fontWeight="700" color="white">My Profile</Text>
      ...
      <ScrollView p="$4" showsVerticalScrollIndicator={false}>
        <YStack gap="$8" pt="$4">
          ...
          <YStack ai="center" gap="$4">
            <ZStack>
              <Circle size={112} bw={2} bc="$primary" p={4} opacity={0.3} />
              <Circle size={112} p={4}>
                <Image 
                  source={{ uri: 'https://picsum.photos/id/64/400/400', width: 104, height: 104 }} 
                  width={104}
                  height={104}
                  br={999}
                />
            ...
            <YStack ai="center" gap="$1">
              <Text color="white" fontSize="$7" fontWeight="700">Sarah Jenkins</Text>
              <Text color="$textSecondary" fontSize="$3" fontWeight="500">@sarah_eats_sf</Text>
              <XStack bg="#392f28" px="$3" py="$1" br="$10" mt="$2">
                <Text color="$primary" fontSize={10} fontWeight="700" textTransform="uppercase" letterSpacing={1}>
                  Foodie Level 5
                </Text>
              </XStack>
            </YStack>
          ...
          <XStack gap="$4">
            <ProfileCard>
              <Text color="$primary" fontSize="$7" fontWeight="800">142</Text>
              <Text color="$textSecondary" fontSize={10} fontWeight="700" textTransform="uppercase" ta="center">
                Dishes Reviewed
              </Text>
            </ProfileCard>
            <ProfileCard>
              <Text color="$primary" fontSize="$7" fontWeight="800">38</Text>
              <Text color="$textSecondary" fontSize={10} fontWeight="700" textTransform="uppercase" ta="center">
                Places Visited
              </Text>
            </ProfileCard>
    ...
    <MenuButton>
      <XStack f={1} ai="center" gap="$4">
        ...
        <YStack f={1}>
          ...
          <Text color="$gray10" fontSize="$1">{subtitle}</Text>
        </YStack>
