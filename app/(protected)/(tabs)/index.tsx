...
export default function HomeScreen() {
  ...
  return (
    <YStack f={1} backgroundColor="$background">
      ...
      >
        <Text fontSize={20} fontWeight="700">Your Eats</Text>
        <XStack gap="$2">
    ...
    <FoodCard>
      <ZStack w="100%" height={220}>
        ...
        <XStack 
          ...
          px="$3" py="$1.5" borderRadius="$3" ai="center" gap="$1"
        >
          <Star size={14} fill="#f26c0d" color="#f26c0d" />
          <Text color="white" fontWeight="700" fontSize={12}>{rating}</Text>
        </XStack>
      </ZStack>
      ...
      <YStack p="$4" gap="$2">
        <YStack>
          ...
          <XStack ai="center" gap="$1">
            ...
            <Text color="$colorSecondary" fontSize={14}>{location} • {distance}</Text>
          </XStack>
        </YStack>
        ...
        <XStack gap="$2" flexWrap="wrap" marginTop="$2">
          {tags?.map((tag) => (
            ...
            >
              ...
              <Text fontSize={10} fontWeight="700" textTransform="uppercase">{tag.label}</Text>
            </FlavorTag>
          ))}
        </XStack>
      </YStack>
